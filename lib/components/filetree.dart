            ...
            child: Column(mainAxisSize: MainAxisSize.max, crossAxisAlignment: CrossAxisAlignment.start, children: [
              Container(
                  ...
                  child: OutlinedButton.icon(
                    onPressed: () async {
                      final newFilePath =
                          await FilePicker.platform.getDirectoryPath(dialogTitle: "Ordner auswählen", initialDirectory: currentRootPath);
                      if (newFilePath != null) {
                        ref.read(selectedDirectoryProvider.notifier).selectDirectory(newFilePath);
                  ...
                  ? [
                      ...
                      Flexible(
                        ...
                        nodeBuilder: (BuildContext context, TreeEntry<FileTreeNode> entry) {
                          return Ink(
                              color: entry.node.path == selectedFile?.path ? Theme.of(context).primaryColor.withOpacity(0.2) : null,
                              child: Container(
                                    ...
                                    child: TreeIndentation(
                                      ...
                                      child: Row(mainAxisSize: MainAxisSize.max, children: [
                                        ...(entry.node.isDir
                                            ...
                                            : [
                                                Container(
                                                    margin: const EdgeInsets.only(right: 5), child: const Icon(Icons.description_outlined))
                                              ]),
                                        Flexible(
                                            child: Text(
